...
class _BookScreenState extends State<BookScreen> {
  ...
  "assets/slider2.jpg"
   ...
   List<Widget>image=[
    Image.asset("assets/book_1.png",fit: BoxFit.cover,),
    Image.asset("assets/book_2.png",fit: BoxFit.cover,),
    Image.asset("assets/book_3.png",fit: BoxFit.cover,),
    Image.asset("assets/book_4.png",fit: BoxFit.cover,),
    Image.asset("assets/book_5.png",fit: BoxFit.cover,),
    Image.asset("assets/book_6.png",fit: BoxFit.cover,),
    Image.asset("assets/book_7.png",fit: BoxFit.cover,),
    Image.asset("assets/book_8.png",fit: BoxFit.cover,),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                Text(btitle[index],style: TextStyle(fontWeight: FontWeight.w700),),
                                Text(price[index],style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16),),
                                Container(
                                  height: 20,
                                  width: 85,
                                  child: Center(
